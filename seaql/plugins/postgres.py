...
class PostgresPlugin(DatabasePlugin):
    ...
    def create_completer(self, smart_completion: bool, settings: dict):
        ...
        special_commands = psql_commands + list(self._pgspecial.commands.keys())
        completer.extend_special_commands(special_commands)
        ...
        completer.extend_keywords(pg_keywords)
